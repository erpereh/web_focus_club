...
export const defaultCMS: CMSContent = {
    ...
    galeria: {
        ...
        stats: [
            ...
            { value: 20, suffix: ' anos', label: 'De experiencia' },
        ...
        resultados: [
            { name: 'Maria Garcia', stat: '-18 kg', statLabel: 'en 4 meses', tag: 'Perdida de peso', story: 'Nunca pense que podria estar asi de bien.', detail: 'De 78 kg a 60 kg.' },
            { name: 'Carlos Martinez', stat: '+12 kg', statLabel: 'masa muscular', tag: 'Hipertrofia', story: 'En 6 meses consegui mas que en anos.', detail: 'Programa de hipertrofia progresivo.' },
            { name: 'Laura Perez', stat: '1er', statLabel: 'puesto competicion', tag: 'Competicion', story: 'Tecnica, nutricion y mentalidad.', detail: 'Preparacion completa para competicion.' },
            { name: 'Ana Rodriguez', stat: '100%', statLabel: 'objetivo cumplido', tag: 'Definicion', story: 'Sali con un estilo de vida nuevo.', detail: 'Programa de definicion y tonificacion.' },
        ],
    },
